/****************************************************************************
** Meta object code from reading C++ file 'oglwidget.hpp'
**
...
#include "../../../../../../include/oglwidget.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'oglwidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 24, 26) // "frameTimeUpdateTimerTicked"

    },
    "OGLWidget\0gameOver\0\0fps\0"
    "frameTimeUpdateTimerTicked"
};
...
void OGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fps((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->frameTimeUpdateTimerTicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OGLWidget::gameOver)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OGLWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OGLWidget::fps)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void OGLWidget::gameOver()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void OGLWidget::fps(QString _t1)
{
